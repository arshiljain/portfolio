import{i as e}from"./rolldown-runtime-aKtaBQYM.js";import{t}from"./react-Dvkprh6u.js";import{t as n}from"./jsx-runtime-DKdBMi_L.js";import{t as r}from"./useBrowserSpecsStore-KSBuyu5W.js";import{t as i}from"./reportError-BYvz8-x-.js";import{a,c as o,i as s,l as c,o as l,s as u}from"./sectionModels-CqSyktdl.js";import{a as d,g as f,i as p,n as m,r as h,s as g,t as _}from"./presets-BdwQB_Rb.js";import{i as v}from"./dpr-CfAtMFij.js";import{t as y}from"./useStickyMountGate-DmTxtK8v.js";import{$a as b,$n as x,Dr as S,Gt as C,Hr as w,In as T,O as ee,Qa as E,Qi as D,Tr as O,U as k,Ua as te,V as A,Yi as j,Zi as M,Zr as ne,da as N,ft as re,ka as P,kr as F,nr as ie,qt as I,rr as L}from"./three.core-DVcoLpfz.js";import{T as R,b as z,g as ae,l as B}from"./events-760a1017.esm-DCPtHAo6.js";import{o as oe,t as se}from"./FluidField-BvVEm9Kv.js";import{a as ce,i as le,l as V,n as H,o as U,p as ue,r as W,s as de,t as fe,u as pe}from"./cameraAnimations-dhQqw_sV.js";import{t as me}from"./Environment-CLl_XlgO.js";import{n as he}from"./reducedMotion-CT1n0ezQ.js";import{n as G,t as ge}from"./useCanvasPointer-CKM2sIQX.js";import{a as _e,c as K,d as ve,i as q,l as ye,n as be,o as xe,r as Se,t as J,u as Ce}from"./SdfRegistry-DVIweSpZ.js";import{t as we}from"./sharedZeroTexture-C5JcVREk.js";import{n as Te,t as Ee}from"./ktx2-loader-7Y-IX7SR.js";import{n as De,t as Oe}from"./colorAndNoise-DY6zB3P7.js";import{a as ke,c as Ae,d as Y,i as je,l as Me,n as Ne,o as Pe,p as X,s as Fe,u as Ie}from"./renderScaleResolve-qdey1xp-.js";import"./layers-Cvg6N2JU.js";import{t as Le}from"./SectionFluidVelocityContext-sekuEx_H.js";var Z=e(t(),1),Q=n(),Re=.064;function ze(){let{isMobile:e,isLandscapeMobile:t,isTouchDevice:n}=r.getState();return e===!0||t===!0||n===!0}function Be(e,t,n,r=10){let i=1-Math.exp(-Math.max(0,Math.min(n,Re))*r);return e+(t-e)*i}var Ve={none:0,linear:1,reinhard:2,cineon:3,aces:4,agx:5,neutral:6},He={none:0,solid:1,linear:2},Ue=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
`,`          vec3 rawUvw = p + 0.5 + uvOffset;
          ...
          float sideDistance = min(min(rawUvw.x, 1.0 - rawUvw.x), min(rawUvw.y, 1.0 - rawUvw.y));
`),new D({glslVersion:C,vertexShader:e.vertexShader,fragmentShader:r,uniforms:{...te.clone(e.uniforms),uVolume:{value:t},uFluidVelocity:{value:we()},uFluidStrength:{value:new E},uFluidDepthStrength:{value:new E(p[0],p[1])},uFluidDistanceRange:{value:new E(d[0],d[1])},uFluidWorldScale:{value:new b(1,1,1)},uFluidResolution:{value:new E(1,1)}},transparent:!0,depthWrite:!1,depthTest:!1,blending:e.blending,side:e.side})}var Ot=Math.PI/2,kt=[-m,m],At=6,jt=14,Mt=5,Nt=new b(1,1,1);function Pt({cameraObject:e,cameraRigObject:t,position:n,target:i,animation:a,positionOffset:o,mobilePositionOffset:c,rotationOffset:l,mobileRotationOffset:u,pointerInfluence:d,behindPointerInfluence:f=1,scrollDrift:p=ue,motion:m,cameraDollyOffset:h=0,cameraDollyTransitionOffset:g=0}){let _=z(e=>e.camera),v=e??_,y=G(),S=r(e=>e.isMobile),C=r(e=>e.isLandscapeMobile),T=(0,Z.useRef)(null),ee=(0,Z.useRef)(null),E=(0,Z.useRef)(null),D=(0,Z.useRef)(null),O=(0,Z.useRef)(null),k=(0,Z.useRef)(null),te=(0,Z.useRef)(null),A=(0,Z.useRef)(null),j=(0,Z.useRef)(null),M=(0,Z.useRef)(null),ne=(0,Z.useRef)(null),re=T.current??=new b,P=ee.current??=new ie,F=E.current??={pitch:0,yaw:0},I=D.current??=new b,L=O.current??=new N,R=k.current??=[0,0,0],B=te.current??=new b,oe=A.current??=new w,se=j.current??=new ie,le=M.current??=new ie,H=fe[a]??fe.none,me=(0,Z.useMemo)(()=>V(o,c,S,C,[0,0,0]),[o,c,S,C]),he=(0,Z.useMemo)(()=>V(l,u,S,C,[0,0,0]),[l,u,S,C]);return ae((e,a)=>{let{transition:o,progress:c,screenOffset:l}=m.current;if(Ke(o))return;let u=r.getState().preferReducedMotion,_=H({position:n,target:i,transition:o,progress:c,screenOffset:u?0:l,scrollDrift:p}),[b,S]=d?.[0]??kt,[C,w]=d?.[1]??kt,{x:T,y:ee,active:E}=y.current,D=E&&!u,O=1-s(l)*(1-f),k=D?x.mapLinear(T,-1,1,b,S)*Ot*O:0,te=D?x.mapLinear(-ee,-1,1,C,w)*Ot*O:0,A=D?At:jt;F.pitch=x.damp(F.pitch,te,A,a),F.yaw=x.damp(F.yaw,k,A,a),I.set(_.position[0]-_.target[0],_.position[1]-_.target[1],_.position[2]-_.target[2]),L.setFromVector3(I),L.theta+=F.yaw,L.phi+=F.pitch,L.makeSafe(),I.setFromSpherical(L),R[0]=_.target[0]+I.x,R[1]=_.target[1]+I.y,R[2]=_.target[2]+I.z,ne.current===null||u?ne.current=h:ne.current=x.damp(ne.current,h,Mt,a);let j=u?0:g*x.clamp(-o,0,1),M=(_.localZOffset??0)+ne.current+j;ce(v,me,he,t),de(v,R,_.target,re,P,M),U(v,t),pe(v);let N=t??v.parent;if(N?.userData.sectionSceneCameraRig){let e=N.userData[W]??=new ie;B.set(..._.position),re.set(..._.target),P.lookAt(B,re,v.up),oe.setFromRotationMatrix(P),se.compose(B,oe,Nt),M!==0&&se.multiply(le.makeTranslation(0,0,M)),e.multiplyMatrices(N.matrixWorld,se)}},-1),null}var Ft=`uniform sampler2D tDiffuse;
